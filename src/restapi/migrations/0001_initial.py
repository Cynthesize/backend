# Generated by Django 2.0.7 on 2018-10-01 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commented_on', models.DateTimeField(default=datetime.datetime(2018, 10, 2, 1, 42, 44, 393917))),
                ('commentator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Idea',
            fields=[
                ...
                ('likes', models.IntegerField(default=0)),
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 10, 2, 1, 42, 44, 393390))),
